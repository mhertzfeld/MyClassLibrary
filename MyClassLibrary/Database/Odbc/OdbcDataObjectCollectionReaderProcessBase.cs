...
namespace MyClassLibrary.Database.Odbc
{
    public abstract class OdbcDataObjectCollectionReaderProcessBase<T_DataObject, T_DataObjectCollection>
        : Database.DataObjectCollectionReaderProcessBase<T_DataObject, OdbcDatabaseClient, T_DataObjectCollection, OdbcParameter, OdbcDataReader, OdbcCommand, OdbcConnection, OdbcDataAdapter, OdbcTransaction>
