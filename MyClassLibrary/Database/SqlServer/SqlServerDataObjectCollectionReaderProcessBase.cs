...
namespace MyClassLibrary.Database.SqlServer
{
    public abstract class SqlServerDataObjectCollectionReaderProcessBase<T_DataObject, T_DataObjectCollection>
        : Database.DataObjectCollectionReaderProcessBase<T_DataObject, T_DataObjectCollection, SqlParameter, SqlDataReader, SqlCommand, SqlConnection, SqlDataAdapter, SqlTransaction>
